export function PapersPage() {
  return (
    <section className="max-w-2xl py-12 sm:py-20">
      <p className="mb-3 font-mono text-[11px] tracking-[.14em] text-[#ed542c]">RESEARCH / SELECTED WORK</p>
      <h1 className="text-5xl font-medium leading-none tracking-[-.06em] sm:text-7xl">Papers &amp; <em className="font-serif font-normal">methods.</em></h1>
